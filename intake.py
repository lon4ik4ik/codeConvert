...
Original file is located at
    https://colab.research.google.com/drive/1WiKClEHo7XAe7LUG8o42lsD7qbG7b7GK
"""

#@title <-- fill in intake parameters then click play button to left { run: "auto", display-mode: "form" }

product_scope = 'Cloud - U-Assist' #@param ["Cloud - U-Assist", "Cloud - U-Analyze", "Cloud - U-SelfServe", "Cloud - U-Assist + U-Analyze", "Cloud - U-Assist + U-SelfServe", "Cloud - U-Assist + U-SelfServe + U-Analyze", "Cloud - U-Analyze + U-SelfServe", "Prem - U-Assist", "Prem - U-Analyze", "Prem - U-SelfServe", "Prem - U-Assist + U-Analyze", "Prem - U-Assist + U-SelfServe", "Prem - U-Assist + U-SelfServe + U-Analyze", "Prem - U-Analyze + U-SelfServe"]

cc_platform = 'Five9' #@param ["Cisco", "Avaya", "Genesys Cloud", "Genesys PureEngage", "Five9", "inContact", "RingCentral", "Twilio", "Talkdesk", "Amazon Connect", "Other->"] {allow-input: true}

total_level_1_call_drivers = '21-30' #@param ["1-5","6-9", "10-20", "21-30", "31-40", "41-50"]
